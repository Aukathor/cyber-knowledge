...
- [Automatisering met OSINT CSI](#automatisering-met-osint-csi)
...
## Automatisering met OSINT CSI

Tijdens de sessie werd naast de live demo ook een geautomatiseerde aanpak getoond.

De bijbehorende openbare repository van K2Sosint is:

[**K2SOsint / OSINT_CSI**](https://github.com/K2SOsint/OSINT_CSI/tree/main)

Het project werd tijdens de sessie gekoppeld aan het automatiseren van delen van het onderzoeksproces en het genereren van een rapport.

De repository is daarom interessant als **praktisch vervolg op de sessie**: de sessienotitie beschrijft de onderzoeksmethode, terwijl het project het bijbehorende technische/automatiseringsartefact vormt.

> 💡 **Kernpunt**
>
> De interessante stap is niet alleen dat een onderzoek geautomatiseerd kan worden, maar dat de eerder beschreven **pivot-logica** onderdeel kan worden van een reproduceerbare workflow.

### Van handmatig naar reproduceerbaar

De live demo kan conceptueel worden weergegeven als:
...
Een geautomatiseerde workflow probeert delen daarvan reproduceerbaar te maken:
...
De repository-link hierboven is een rechtstreeks onderdeel van de sessiecontext. De precieze technische werking, mogelijkheden en beperkingen van de huidige repository-versie zijn in deze sessienotitie niet verder beoordeeld. Deze notitie beschrijft alleen de rol die het project tijdens de sessie kreeg.
...
| 11 | Automatisering kan een onderzoek reproduceerbaarder maken |
...
### 06 — Automatisering is geen vervanging voor beoordeling

Een geautomatiseerde workflow kan helpen met verzamelen, correleren en rapporteren.

De onderzoeker moet echter blijven beoordelen:

- welke signalen daadwerkelijk relevant zijn;
- welke relaties sterk genoeg zijn;
- welke conclusies gerechtvaardigd zijn;
- en waar onzekerheid blijft bestaan.
...
De repository **OSINT CSI** sluit hier mooi op aan: het is het technische artefact dat bij deze sessie hoort en laat zien hoe delen van een dergelijke onderzoeksmethode kunnen worden geautomatiseerd.
...
Daar kwam vervolgens nog een tweede laag bij: **automatisering**.

De handmatige onderzoekslijn kan worden omgezet in een reproduceerbare workflow waarin verzameling, correlatie en rapportage deels worden geautomatiseerd.

De belangrijkste les blijft echter hetzelfde:
...
Kan ik de relatie onderbouwen?
     ↓
Kan ik dit proces verantwoord automatiseren?
```
...
>
> En automatisering maakt die werkwijze schaalbaarder — maar neemt de noodzaak van menselijke beoordeling niet weg.

---

## Bronstatus

Deze sessie is **uitsluitend gebaseerd op eigen sessienotities**, aangevuld met de tijdens de sessie genoemde repository.

### Sessiebron

**Henri Beek a.k.a. K2Sosint — OSINT CSI: Crypto Scam Investigations**

### Technisch artefact

**K2SOsint — OSINT_CSI**

https://github.com/K2SOsint/OSINT_CSI/tree/main
...
- 🔗 **Repository** — publiek project dat tijdens de sessie als automatiserings-/onderzoeksartefact werd genoemd.

...
In de demo werd ShadowDragon gebruikt als voorbeeld van een externe OSINT-/enrichmentbron die vanuit een andere gevonden entity kan worden ingezet.

Dat sluit aan bij het voorbeeld uit de sessie:
...
Het belangrijke punt binnen de sessie was daarmee niet de specifieke functionaliteit van ShadowDragon, maar de **workflow**:

een resultaat uit de ene bron wordt een nieuwe input voor een andere bron.

> 💡 **Kernpunt**
>
> ShadowDragon is in deze context vooral interessant als voorbeeld van een externe bron die als **enrichment- en pivotstap** binnen een grotere intelligence-workflow kan worden gebruikt.
>
> De sessienotities ondersteunen geen volledige beschrijving van de actuele mogelijkheden van ShadowDragon. Daarom worden die hier niet verder ingevuld.
...
**ShadowDragon**  
Tijdens de sessie genoemd als voorbeeld van een externe OSINT-/enrichmentbron. De huidige officiële documentatie beschrijft ShadowDragon Horizon als enterprise OSINT-platform met onder meer identity intelligence, link analysis, monitoring en integraties.
...
- 🔗 **Genoemde technologie** — ShadowDragon is opgenomen zoals het tijdens de sessie als voorbeeld werd genoemd.
